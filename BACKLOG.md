...
Last updated: 2026-07-22 (agent: added substantial-content-gated city aggregation pages for organic/local discovery and removed only the city portion of the parked landing-page item; no priority changes. Earlier same day: price-alert design proposal and phased demand gate).
