...
- **Phase 4 — started 2026-09-24 on the stacked branch `milestone/2027-launch-readiness-phase4`; no PR.**
  ...
  - **Proposed, awaiting owner approval by number.** Copy items P1–P11 in `docs/audits/2026-09-phase4-ux-copy-proposals.md`: a five-second comparison module, one "How we make money" disclosure that states the button order favours paying sites, a Ticketmaster "See tickets" label, "recent" rather than "current" prices, a stale provenance date, and tighter artist leads, fact strip and empty states. Nothing in P1–P11 is applied yet.
