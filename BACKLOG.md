...
Last updated: 2026-07-31 (agent: reconciled the owner-reviewed storefront and tour-label cleanup with the newer ten-artist Shell batch and provider-sync state. Five official Ticketmaster links were restored, one duplicate Shakira row was removed and tombstoned, seven confirmed tour mappings were applied, and routine-hygiene counts were refreshed. Past-only audit findings remain in artifacts without presenting as current human work. Priority order and scope are unchanged. Earlier: 2026-07-28 fact corrections; 2026-07-22 city aggregation and price-alert design).
...
- **`needs_recheck` re-checks:** **46 events** carry this state as of 2026-07-31 (gracie-abrams 7, niall-horan 7, sombr 6, olivia-rodrigo 6, zach-bryan 4, bts 4, john-summit 3, tame-impala 3, bad-bunny 2, ed-sheeran 2, doja-cat 1, jelly-roll 1). Verified resale provenance keeps 27 standalone SeatGeek CTAs publishable and gives **39 of 46** rows at least one independent resale route. The 7 fully CTA-suppressed rows are all past events; no upcoming recheck row is fully suppressed. Re-check Ticketmaster storefront URLs periodically; never restore from the Discovery `url` field alone.
