...
- **Phase 5 — longform edit done 2026-09-24 on the stacked branch `milestone/2027-launch-readiness-phase5` (draft PR); awaiting owner review.** All 18 guides and the 4 published blog posts were refined, not rewritten: frontmatter (except blog `updated:`), headings and links are unchanged. Stale claims about how prices and artist promotion work were corrected. Notes and `TODO(Ollie)` voice slots: `docs/audits/2026-09-phase5-longform-sample.md`.
