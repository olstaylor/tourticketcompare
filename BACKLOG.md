...
Last updated: 2026-07-31 (agent: fact addition only — recorded the owner-approved ten-artist Shell batch under Active priority 3; priority order and scope are unchanged. Earlier 2026-07-28 (agent: fact corrections only, no priority or scope changes — recounted the `needs_recheck` figures in Routine data hygiene, which had drifted from 20 to 24 since 2026-07-16. See `PROJECT_STATUS.md` for the same-day IndexNow automation, the recount of the date-derived city/venue/artist-city counts, and the new Active risk recording that indexable surface has grown while audience has not. Earlier: 2026-07-22 — added substantial-content-gated city aggregation pages for organic/local discovery and removed only the city portion of the parked landing-page item; price-alert design proposal and phased demand gate).
...
_[Updated 2026-07-31, agent — Shell phase, fact addition only]_ **Ten owner-approved touring artists added as `review_required` shells:** Karol G, Foo Fighters, Metallica, Rush, Muse, My Chemical Romance, Teddy Swims, Five Finger Death Punch, System Of A Down and Laura Pausini. The owner browser-checked the Ticketmaster identities before the Shell write. All rows remain noindex and carry no CTA, event, registry identity, verification timestamp or public provider link. Before Promote, regenerate an API-captured SeatGeek/Ticketmaster manifest for these names with `--allow-existing-shells`, confirm the captured identities match the reviewed destinations, and complete the per-artist browser checklist. Confirmed 2027 touring helped prioritise the cohort, but no tour/date claim is stored in the shell records; unannounced 2027 possibilities remain outside public data.

### 4. Routine data hygiene (recurring)

- **`needs_recheck` re-checks:** _[Recounted 2026-07-28, agent — was "20 events as of 2026-07-16 (olivia-rodrigo 6, zach-bryan 5, bts 4, bad-bunny 2, ed-sheeran 2, shakira 1)"; the jelly-roll/tame-impala promotions and subsequent discovery runs moved it.]_ **24 events** carry this state as of 2026-07-28 (olivia-rodrigo 6, zach-bryan 5, bts 4, tame-impala 3, bad-bunny 2, ed-sheeran 2, shakira 1, jelly-roll 1) — the owner's 2026-07-15 recheck left 13, then discovery PR #472 added 5 zach-bryan short-form-URL rows and re-added the deleted shakira "Shakira Stadium" and bad-bunny Brussels rows (see `PROJECT_STATUS.md` Active risks), and post-promotion discovery added the 4 jelly-roll/tame-impala rows. Verified resale provenance keeps **17** SeatGeek CTAs publishable (olivia-rodrigo 6, zach-bryan 4, tame-impala 3, bts 2, ed-sheeran 1, jelly-roll 1); 7 rows have no resale provider and remain fully CTA-suppressed. Re-check Ticketmaster storefront URLs periodically; never restore from the Discovery `url` field alone.
