...
- `public/data/events.json`: **1022 events** — 289 `human_verified`, 582 `machine_high_confidence`, 151 `needs_recheck`. Verified event-level provider provenance: SeatGeek 241 (293 rows carry a stored `seatgeek_url`), Vivid Seats 719, TicketNetwork 670, Ticket Liquidator 562, StubHub International 498. Of the 151 `needs_recheck` rows: 74 retain a standalone SeatGeek CTA, 88 retain a standalone Vivid Seats CTA, and 23 have no independently verified resale provider and remain fully CTA-suppressed. Of those 13, 7 are past and **6 are upcoming** — those six upcoming dates render no ticket CTA at all (hand-checked 2026-08-24; only the counts before this sentence are machine-pinned, so this split moves with the calendar).
...
|---|---|---|---|---|---|---|---|
| beyonce | 2026-09-01 | 0 | 0 | 0 | 0 | — | No event records; artist-level CTA only. |
...
| bad-bunny | 2026-09-01 | 28 | 0 | 0 | **4** | DeBÍ TiRAR MáS FOToS World Tour | No SeatGeek URLs (EU legs not listed on SeatGeek). Recheck rows: Marseille 7/1 and the re-added Brussels `.com` row — both CTA-suppressed. |
| morgan-wallen | 2026-09-01 | 18 | 14 | 4 | 0 | Still the Problem Tour | — |
...
| raye | 2026-09-01 | 0 | 0 | 0 | 0 | — | No event records; artist-level CTA only. |
| charli-xcx | 2026-06-18 | 11 | 11 | 11 | 0 | Music, Fashion, Film Tour | — |
| tate-mcrae | 2026-09-01 | 0 | 0 | 0 | 0 | — | No event records; artist-level CTA only. |
...
| rosalia | 2026-09-01 | 6 | 1 | 0 | 0 | LUX TOUR 2026 | Houston 6/23 renders a plain "Check Ticketmaster" link (owner-verified). |
| post-malone | 2026-09-01 | 5 | 0 | 0 | 0 | — | `tour_name` blank pending human verification. Vivid Seats covers 3 events. |
...
| jelly-roll | 2026-09-01 | 1 | 0 | 0 | **1** | — | `tour_name` blank pending human verification. |
...
| luke-combs | 2026-08-28 | 12 | 1 | 1 | **2** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
...
| in-flames | 2026-09-01 | 0 | 0 | 0 | 0 | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
