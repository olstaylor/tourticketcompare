...
- `public/data/events.json`: **1020 events** — 289 `human_verified`, 582 `machine_high_confidence`, 149 `needs_recheck`. Verified event-level provider provenance: SeatGeek 201 (253 rows carry a stored `seatgeek_url`), Vivid Seats 499, TicketNetwork 462, Ticket Liquidator 392, StubHub International 390. Of the 149 `needs_recheck` rows: 32 retain a standalone SeatGeek CTA, 45 retain a standalone Vivid Seats CTA, and 81 have no independently verified resale provider and remain fully CTA-suppressed. Of those 13, 7 are past and **6 are upcoming** — those six upcoming dates render no ticket CTA at all (hand-checked 2026-08-24; only the counts before this sentence are machine-pinned, so this split moves with the calendar).
...
- Route surface — **generated, do not hand-edit.** `npm run status:surface:write` refreshes this line from the audit's own render of every route (robots meta as served, not as inferred), and `npm run audit:indexable-surface:check` — which runs in `test:mvp` — warns when it goes stale. Exclusion reasons, expiry horizon and the stored baseline live in `reports/indexable-surface/`.
  ...
  Generated 2026-08-28: **668 rendered / 271 indexable**. By type (rendered/indexable): home 1/1 · index 5/5 · static 9/9 · guide 18/18 · blog-post 3/3 · blog-tag 3/2 · artist 50/42 · city 107/45 · venue 149/54 · artist-city 323/92.
  <!-- /generated:route-surface -->
...
| don-omar | 2026-08-28 | 39 | 0 | 0 | **6** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
| luke-combs | 2026-08-28 | 11 | 0 | 0 | **1** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
| blue-october | 2026-08-28 | 65 | 0 | 0 | **24** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
| pentatonix | 2026-08-28 | 28 | 0 | 0 | **3** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
...
| nothing-but-thieves | 2026-08-28 | 26 | 0 | 0 | **5** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
| trivium | 2026-08-28 | 34 | 0 | 0 | **11** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
| sabaton | 2026-08-28 | 13 | 0 | 0 | **4** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
...
| beartooth | 2026-08-28 | 26 | 0 | 0 | **8** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
