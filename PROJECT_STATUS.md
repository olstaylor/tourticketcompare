...
- Route surface — **generated, do not hand-edit.** `npm run status:surface:write` refreshes this line from the audit's own render of every route (robots meta as served, not as inferred), and `npm run audit:indexable-surface:check` — which runs in `test:mvp` — warns when it goes stale. Exclusion reasons, expiry horizon and the stored baseline live in `reports/indexable-surface/`.
  ...
  Generated 2026-08-29: **1137 rendered / 320 indexable**. By type (rendered/indexable): home 1/1 · index 5/5 · static 9/9 · guide 18/18 · blog-post 3/3 · blog-tag 3/2 · artist 50/42 · city 173/56 · venue 298/75 · artist-city 577/109.
  <!-- /generated:route-surface -->
...
|---|---|---|---|---|---|---|---|
| beyonce | 2026-08-30 | 0 | 0 | 0 | 0 | — | No event records; artist-level CTA only. |
...
| bad-bunny | 2026-08-30 | 28 | 0 | 0 | **4** | DeBÍ TiRAR MáS FOToS World Tour | No SeatGeek URLs (EU legs not listed on SeatGeek). Recheck rows: Marseille 7/1 and the re-added Brussels `.com` row — both CTA-suppressed. |
| morgan-wallen | 2026-08-30 | 18 | 14 | 4 | 0 | Still the Problem Tour | — |
...
| raye | 2026-08-30 | 0 | 0 | 0 | 0 | — | No event records; artist-level CTA only. |
| charli-xcx | 2026-06-18 | 11 | 11 | 11 | 0 | Music, Fashion, Film Tour | — |
| tate-mcrae | 2026-08-30 | 0 | 0 | 0 | 0 | — | No event records; artist-level CTA only. |
...
| rosalia | 2026-08-30 | 6 | 1 | 0 | 0 | LUX TOUR 2026 | Houston 6/23 renders a plain "Check Ticketmaster" link (owner-verified). |
| post-malone | 2026-08-30 | 5 | 0 | 0 | 0 | — | `tour_name` blank pending human verification. Vivid Seats covers 3 events. |
...
| jelly-roll | 2026-08-30 | 1 | 0 | 0 | **1** | — | `tour_name` blank pending human verification. |
...
| in-flames | 2026-08-30 | 0 | 0 | 0 | 0 | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
