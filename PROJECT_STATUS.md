...
| teddy-swims | 2026-08-22 | 48 | 7 | 7 | **16** | — | Promoted 2026-08-21. |
...
| beartooth | 2026-08-28 | 27 | 4 | 4 | **9** | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
| polyphia | 2026-09-09 | 22 | 0 | 0 | **7** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| stella-lefty | 2026-09-09 | 33 | 0 | 0 | **8** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| tobymac | 2026-09-09 | 5 | 0 | 0 | 0 | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| saint-levant | 2026-09-09 | 15 | 0 | 0 | **3** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| the-airborne-toxic-event | 2026-09-09 | 5 | 0 | 0 | **5** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| andrea-bocelli | 2026-09-09 | 16 | 0 | 0 | **2** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| morat | 2026-09-09 | 13 | 0 | 0 | **2** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| missio | 2026-09-09 | 28 | 0 | 0 | **20** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| vnv-nation | 2026-09-09 | 5 | 0 | 0 | **5** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| michelle-branch | 2026-09-09 | 31 | 0 | 0 | **12** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
...
| fkj | 2026-09-09 | 18 | 0 | 0 | **4** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| sylvan-esso | 2026-09-09 | 28 | 0 | 0 | **10** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| blondshell | 2026-09-09 | 5 | 0 | 0 | **2** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
| pink-martini | 2026-09-09 | 24 | 0 | 0 | **13** | — | Promoted 2026-09-09 after owner confirmation of both API-captured provider destinations (workflow run 34371114685). Verified registry and artist links; no event records yet, so the board remains an empty watchlist without buttons. Event ingestion follows merge and deployment. |
