...
- Route surface — **generated, do not hand-edit.** `npm run status:surface:write` refreshes this line from the audit's own render of every route (robots meta as served, not as inferred), and `npm run audit:indexable-surface:check` — which runs in `test:mvp` — warns when it goes stale. Exclusion reasons, expiry horizon and the stored baseline live in `reports/indexable-surface/`.
  ...
  Generated 2026-09-04: **1134 rendered / 317 indexable**. By type (rendered/indexable): home 1/1 · index 5/5 · static 9/9 · guide 18/18 · blog-post 4/4 · blog-tag 3/3 · artist 50/42 · city 173/56 · venue 299/73 · artist-city 572/106.
  <!-- /generated:route-surface -->
...
| sombr | 2026-07-30 | 43 | 6 | 6 | **12** | You Are The Reason Tour | All 6 recheck rows retain independent verified SeatGeek coverage. |
...
| in-flames | 2026-09-02 | 0 | 0 | 0 | 0 | — | Promoted 2026-08-26; owner browser-checked both destinations. No event records yet; artist-level CTA only. |
