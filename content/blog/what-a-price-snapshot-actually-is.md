...
Buttons appear in a fixed order: sites that pay the site a commission first, the unpaid Ticketmaster link last. The page says so next to the buttons. The order is the same whether or not any figure is present. It isn't a ranking, and nothing on the card sorts by price or points at a "best" option.
