---
title: Primary vs Resale Concert Tickets
...
Resale is different: the ticket arrives when the seller transfers it, sometimes through another company's system. Ticketmaster's help page says that when it lists resale tickets for an event another company ticketed, the seller transfers them from that original provider's app, and you need an account there to access them. Some transfer at once; others wait until close to the date. SeatGeek's delivery help page, for example, says some tickets are available immediately after purchase while others are released closer to the event, often 24 to 48 hours before the start time. Marketplaces set a deadline by which transfer must happen, but the real-world window can be tighter than it looks. If you're travelling or booking transport in advance, confirm the delivery timing before buying. [Ticket delivery and transfer timing](/guides/ticket-delivery-and-transfer-timing) covers this in full.

## So which should you pick?

**Start with primary or official resale** when it is the named official path and the exact seats, total, delivery and terms work for you. It gives you a clear reference point for the show you want.

**Consider marketplace resale** when the official path does not fit your needs, only after checking that the listing is seller-set, the seat and transfer detail are clear, and the total still works once every required charge is shown.

Neither route removes the final checks: confirm the date and venue, ticket type, seat section, final total, delivery timing, and refund, cancellation and transfer terms before committing.

## FAQ

**What is the difference between a primary and resale ticket?**

A primary ticket is sold through an authorised ticketing source for the event. A resale ticket is listed by a previous buyer or professional reseller on a marketplace. Some platforms carry both, so read the listing label rather than relying on the platform name.

**Is a primary ticket always cheaper than resale?**

No. Prices, fees, seats, and availability vary. Compare the final checkout total for equivalent tickets and confirm whether each listing is primary or resale.

**When should I consider a resale ticket?**
