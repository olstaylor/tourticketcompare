...
| `author` | no | Defaults to `TourTicketCompare`, the site itself. Only that exact name resolves the BlogPosting `author` to the Organization node; any other name is emitted as its own Person. |
