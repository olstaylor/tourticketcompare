...
| `impact-marketplace-price-snapshots.yml` | hourly + push to its own workflow/config + dispatch | Exact-ID D1 snapshots for TicketNetwork + StubHub International, then a 90-day history prune. D1 only, never the repo. |
