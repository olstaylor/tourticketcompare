// Shared venue-local date/instant resolution for provider sync scripts and the
// event identity module (functions/_event-pages.js). Lives under functions/ so
// the Pages runtime can import it; scripts/lib/event-local-date.mjs re-exports
// it, so the provider matchers keep their import path.
//
