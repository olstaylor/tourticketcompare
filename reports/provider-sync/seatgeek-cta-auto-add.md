...
Generated: 2026-08-29T11:35:33.403Z
...
- Total events in data: 1020
- Ticketmaster-verified events: 306
- Events already carrying a valid SeatGeek URL: 296
- Ticketmaster-verified events already carrying a valid SeatGeek URL: 176
- Ticketmaster-verified events still missing a valid SeatGeek URL before this run: 130
- Eligible (upcoming, resolvable local date) after pre-API filtering: 46
- Skipped before any API call: 84 (past_event: 84)
- Events this run can check (window size): 30
- Rotation: window 1 of 2 (key 20694)
...
- Stopped early: no
- Next resume showId: tm-olivia-rodrigo-2027-london-1adfz_agkdqyuqd
- Next recommended resume command: node scripts/enrich-seatgeek-events.mjs --apply-high-confidence --max-api-calls 150 --resume-from 'tm-olivia-rodrigo-2027-london-1adfz_agkdqyuqd'
...
- 296 event(s) already carried valid SeatGeek URLs before this run, including 176 Ticketmaster-verified event(s).
- This run queried only the 130 Ticketmaster-verified event(s) that were still missing a valid `seatgeek_url`.
