...
Generated: 2026-08-19T05:39:17.424Z
...
- Eligible (upcoming, resolvable local date) after pre-API filtering: 51
- Skipped before any API call: 76 (past_event: 76)
- Events this run can check (window size): 30
- Rotation: window 1 of 2 (key 20684)
...
- Stopped early: no
- Next resume showId: tm-olivia-rodrigo-2027-london-1adfz_agkusg7f3
- Next recommended resume command: node scripts/enrich-seatgeek-events.mjs --apply-high-confidence --max-api-calls 150 --resume-from 'tm-olivia-rodrigo-2027-london-1adfz_agkusg7f3'
