...
Generated: 2026-09-16T09:50:50.755Z
...
- Total events in data: 1392
- Ticketmaster-verified events: 306
- Events already carrying a valid SeatGeek URL: 339
- Ticketmaster-verified events already carrying a valid SeatGeek URL: 168
- Ticketmaster-verified events still missing a valid SeatGeek URL before this run: 138
- Eligible (upcoming, resolvable local date) after pre-API filtering: 43
- Skipped before any API call: 95 (past_event: 95)
- Events this run can check (window size): 30
- Rotation: window 1 of 2 (key 20712)
...
- 339 event(s) already carried valid SeatGeek URLs before this run, including 168 Ticketmaster-verified event(s).
- This run queried only the 138 Ticketmaster-verified event(s) that were still missing a valid `seatgeek_url`.
