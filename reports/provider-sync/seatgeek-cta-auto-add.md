...
Generated: 2026-08-17T05:43:00.130Z
...
- Total events in data: 610
- Ticketmaster-verified events: 306
- Events already carrying a valid SeatGeek URL: 251
...
- Skipped before any API call: 75 (past_event: 75)
- Events this run can check (window size): 30
- Rotation: window 1 of 2 (key 20682)
...
- Stopped early: no
- Next resume showId: tm-olivia-rodrigo-2027-london-1adfz_agkuyj7ah
- Next recommended resume command: node scripts/enrich-seatgeek-events.mjs --apply-high-confidence --max-api-calls 150 --resume-from 'tm-olivia-rodrigo-2027-london-1adfz_agkuyj7ah'
...
- 251 event(s) already carried valid SeatGeek URLs before this run, including 179 Ticketmaster-verified event(s).
