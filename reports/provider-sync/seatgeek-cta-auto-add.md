...
Generated: 2026-09-17T09:56:05.279Z
...
- Total events in data: 1402
- Ticketmaster-verified events: 306
- Events already carrying a valid SeatGeek URL: 338
- Ticketmaster-verified events already carrying a valid SeatGeek URL: 167
- Ticketmaster-verified events still missing a valid SeatGeek URL before this run: 139
- Eligible (upcoming, resolvable local date) after pre-API filtering: 43
- Skipped before any API call: 96 (past_event: 96)
- Events this run can check (window size): 30
- Rotation: window 2 of 2 (key 20713)
...
- 338 event(s) already carried valid SeatGeek URLs before this run, including 167 Ticketmaster-verified event(s).
- This run queried only the 139 Ticketmaster-verified event(s) that were still missing a valid `seatgeek_url`.
