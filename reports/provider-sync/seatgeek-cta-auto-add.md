...
Generated: 2026-08-24T05:45:16.598Z
...
- Skipped before any API call: 80 (past_event: 80)
- Events this run can check (window size): 30
- Rotation: window 2 of 2 (key 20689)
- Runs needed to check every eligible event once: 2
- Events selected/logged by this run: 19
- Events checked by this run: 19
- API calls made: 95
- Rate-limit responses: 0
- URLs added: 0
- Events skipped: 19
- no_candidates_returned: 18
...
- 255 event(s) already carried valid SeatGeek URLs before this run, including 177 Ticketmaster-verified event(s).
