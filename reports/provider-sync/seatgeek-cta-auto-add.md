...
Generated: 2026-09-21T10:35:36.146Z
...
- Events already carrying a valid SeatGeek URL: 340
...
- Skipped before any API call: 100 (past_event: 100)
- Events this run can check (window size): 30
- Rotation: window 2 of 2 (key 20717)
...
- 340 event(s) already carried valid SeatGeek URLs before this run, including 166 Ticketmaster-verified event(s).
