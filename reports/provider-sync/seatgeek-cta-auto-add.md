...
Generated: 2026-09-26T09:50:00.665Z
...
- Total events in data: 1973
- Ticketmaster-verified events: 306
- Events already carrying a valid SeatGeek URL: 361
...
- Skipped before any API call: 103 (past_event: 103)
- Events this run can check (window size): 30
- Rotation: window 1 of 2 (key 20722)
...
- 361 event(s) already carried valid SeatGeek URLs before this run, including 164 Ticketmaster-verified event(s).
