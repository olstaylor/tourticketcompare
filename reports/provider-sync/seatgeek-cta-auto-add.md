...
Generated: 2026-09-20T09:44:24.040Z
...
- Total events in data: 1422
- Ticketmaster-verified events: 306
- Events already carrying a valid SeatGeek URL: 342
...
- Eligible (upcoming, resolvable local date) after pre-API filtering: 42
- Skipped before any API call: 98 (past_event: 98)
- Events this run can check (window size): 30
- Rotation: window 1 of 2 (key 20716)
...
- Stopped early: no
- Next resume showId: tm-olivia-rodrigo-2027-london-1adfz_agkdd-fh3
- Next recommended resume command: node scripts/enrich-seatgeek-events.mjs --apply-high-confidence --max-api-calls 150 --resume-from 'tm-olivia-rodrigo-2027-london-1adfz_agkdd-fh3'
...
- 342 event(s) already carried valid SeatGeek URLs before this run, including 166 Ticketmaster-verified event(s).
