...
Generated: 2026-09-02T09:27:08.494Z
...
- Eligible (upcoming, resolvable local date) after pre-API filtering: 44
- Skipped before any API call: 88 (past_event: 88)
- Events this run can check (window size): 30
- Rotation: window 1 of 2 (key 20698)
...
- Stopped early: no
- Next resume showId: tm-olivia-rodrigo-2027-london-1adfz_agkdj-m1i
- Next recommended resume command: node scripts/enrich-seatgeek-events.mjs --apply-high-confidence --max-api-calls 150 --resume-from 'tm-olivia-rodrigo-2027-london-1adfz_agkdj-m1i'
