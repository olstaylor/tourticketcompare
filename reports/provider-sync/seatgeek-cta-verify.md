...
Generated: 2026-07-26T07:46:42.591Z
...
- Mode: apply
- Events selected: 187 (needs_recheck: 19, provenance backfill: 4, stale re-check: 181)
...
| --- | --- | --- | --- | --- | --- |
| tm-morgan-wallen-2026-ann-arbor-z7r9jz1a7qtbf | morgan-wallen | unverify (applied) | - | - | stored URL failed: SeatGeek /events/17873140 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
...
| tm-ariana-grande-2026-boston-010063289ef611c4 | ariana-grande | unverify (applied) | - | - | stored URL failed: SeatGeek /events/17724148 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
...
| tm-shakira-2026-atlantic-city-vv17fz_6gkb5efrp | shakira | unverify (applied) | - | - | stored URL failed: SeatGeek /events/18157403 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
| tm-ed-sheeran-2026-santa-clara-1c006331c1a54d19 | ed-sheeran | unverify (applied) | - | - | stored URL failed: SeatGeek /events/17738443 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
