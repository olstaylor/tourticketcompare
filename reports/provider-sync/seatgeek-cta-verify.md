...
Generated: 2026-08-23T05:42:08.802Z
...
- Mode: apply
- Events selected: 218 (needs_recheck: 72, provenance backfill: 3, stale re-check: 176)
- Events skipped before API checks: 87
- API calls made: 223
...
| tm-bruno-mars-2026-east-rutherford-k7vgfbydo-qcd | bruno-mars | unverify (applied) | - | - | stored URL failed: SeatGeek /events/18004642 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
...
| tm-ed-sheeran-2026-toronto-1000632fe9ca4361 | ed-sheeran | unverify (applied) | - | - | stored URL failed: SeatGeek /events/17738478 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
...
| tm-bts-2026-toronto-1avzz_egkiiidcu | bts | unverify (applied) | - | - | stored URL failed: SeatGeek /events/18010334 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
...
| tm-zach-bryan-2026-arlington-z7r9jz1a7r4vu | zach-bryan | unverify (applied) | - | - | stored URL failed: SeatGeek /events/17870796 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
...
| tm-bad-bunny-2026-san-juan-z7r9jz1aazgb_ | bad-bunny | unverify (applied) | - | - | stored URL failed: SeatGeek /events/18513310 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
| tm-bad-bunny-2026-san-juan-z7r9jz1aazm40 | bad-bunny | verify (applied) | 18513312 | https://seatgeek.com/bad-bunny-tickets/san-juan-puerto-rico-hiram-bithorn-stadium-2026-08-23-7-pm/concert/18513312 | - |
