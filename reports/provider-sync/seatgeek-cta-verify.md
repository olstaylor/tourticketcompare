...
Generated: 2026-08-26T05:45:16.613Z
...
- Mode: apply
- Events selected: 211 (needs_recheck: 69, provenance backfill: 1, stale re-check: 173)
- Events skipped before API checks: 91
- API calls made: 212
- Verified provenance written: 173
- URLs added: 0
- URLs corrected: 0
- URLs cleared: 0
...
| tm-bruno-mars-2026-east-rutherford-k7vgfbydoxccx | bruno-mars | unverify (applied) | - | - | stored URL failed: SeatGeek /events/18013033 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
