...
Generated: 2026-08-17T05:46:47.643Z
...
- Mode: apply
- Events selected: 189 (needs_recheck: 40, provenance backfill: 0, stale re-check: 174)
- Events skipped before API checks: 83
- API calls made: 190
- Verified provenance written: 174
- URLs added: 0
- URLs corrected: 0
- URLs cleared: 0
...
| tm-bts-2026-arlington-z7r9jz1a7oout | bts | unverify (applied) | - | - | stored URL failed: SeatGeek /events/18009296 returned HTTP 404 (listing confirmed gone); previously verified record no longer matches |
