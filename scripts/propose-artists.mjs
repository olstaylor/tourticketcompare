...
function buildAffiliateActions(artistGroups) {
  const lines = [
    ...
    "in `functions/api/out.js` redirects to the stored ticketmaster.com event URL",
    "as a plain, unmonetized link (the site is no longer in the Ticketmaster",
    "affiliate programme; no Impact wrapping is applied to Ticketmaster).",
    "",
    "=> No Impact dashboard work applies to Ticketmaster CTAs. The candidate",
    "   `events.csv` in this batch supplies the verified `ticketmaster_url`",
    "   values needed for this path.",
    "",
    ...
    "Ticketmaster entry uses the plain canonical ticketmaster.com artist URL",
    "captured from the Discovery API. This script does NOT edit that protected",
    "file and does NOT invent URLs.",
    "",
    "### Per-artist status",
    ""
  ];
