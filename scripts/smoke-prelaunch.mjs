...
const expectedH1 = new Map([
  ["/", "Compare resale ticket prices for major tours"],
...
assert(
  joinedPublic.includes("Compare resale ticket prices for major tours"),
...
assert(serverMorganWithSeatGeek.text.includes("Prices shown come directly from our partners, SeatGeek and Vivid Seats. Providers set final prices, fees, and availability — confirm the total at checkout."), "server-rendered show board should include one concise provider-change disclosure");
...
assert(appJs.includes("Prices shown come directly from our partners, SeatGeek and Vivid Seats. Providers set final prices, fees, and availability — confirm the total at checkout."), "hydration should preserve the concise show-board provider disclosure");
...
assert(vsConfiguredPage.text.includes("Prices shown come directly from our partners, SeatGeek and Vivid Seats. Providers set final prices, fees, and availability — confirm the total at checkout."), "server-rendered Vivid Seats CTA page should include the concise show-board provider disclosure");
...
assert(beyonceShowBoard.includes("We do not publish upcoming Beyoncé dates or ticket buttons until the destination has been checked"), "zero-event empty state must explain why no ticket links are shown");
assert(beyonceShowBoard.includes("no unverified dates, no fake prices"), "zero-event empty state must reinforce safe publishing standards");
